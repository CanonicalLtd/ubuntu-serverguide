...
## Overview {#dns-configuration-overview}
...
## Caching Nameserver {#dns-caching-configuration}
...
## Primary Master {#dns-primarymaster-configuration}
...
### Forward Zone File {#dns-forward-zone-file}
...
### Reverse Zone File {#dns-reverse-zone-file}
...
## Secondary Master {#dns-secondarymaster-configuration}
...
### named-checkzone {#dns-testing-configuration}
...
> **Note**
>
> Note: the *debug* option can be set from 1 to 3. If a level isn't specified
