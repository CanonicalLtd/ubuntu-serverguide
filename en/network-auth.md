...
!!! Note: There should be a *SUCCEEDED* message if the propagation worked. If there is
...
!!! Note: Some guides specify that "password server" should be specified and pointed
